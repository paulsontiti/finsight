...
// @ts-nocheck 
/*
 * This file exports the `SavingsPlan` model and its related types.
 *
...
export type GetSavingsPlanAggregateType<T extends SavingsPlanAggregateArgs> = {
      [P in keyof T & keyof AggregateSavingsPlan]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSavingsPlan[P]>
    : Prisma.GetScalarType<T[P], AggregateSavingsPlan[P]>
}
...
type GetSavingsPlanGroupByPayload<T extends SavingsPlanGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SavingsPlanGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SavingsPlanGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SavingsPlanGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SavingsPlanGroupByOutputType[P]>
      }
    >
  >
...
export type SavingsPlanCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SavingsPlanFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SavingsPlanDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SavingsPlan'], meta: { name: 'SavingsPlan' } }
  /**
   ...
   * })
  **/
  count<T extends SavingsPlanCountArgs>(
    args?: Prisma.Subset<T, SavingsPlanCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SavingsPlanCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SavingsPlanGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SavingsPlanGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSavingsPlanGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
